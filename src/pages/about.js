  ...
  return (
    <Layout pageName="about">
      ...
      <Container type="content">
        ...
        <h2>{companyName}</h2>
        <p className="innerPara">{siteDescription}</p>
        ...
        <p className="innerPara">Kenny Tran</p>
        <p className="innerPara">Brian Lucero</p>
        <p className="innerPara">Kevin Espinoza</p>
        <p className="innerPara">Andres Jaramillo</p>
        ...
        <p className="innerPara">
          <a href="https://github.com/ActiveConclusion/COVID19_mobility">
            ActiveConclusion
          </a>
        </p>
        ...
        <p className="innerPara">
          <a href="https://info.gesundheitsministerium.at/">
