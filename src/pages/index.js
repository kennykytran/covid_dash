...
const IndexPage = () => {
  ...
  const dashboardStats = [
    {
      ...
      secondary: {
        label: "Total Cases Per 1 Million",
        value: commafy(parseInt(stats?.casesPerOneMillion)),
      },
    },
    {
      primary: { label: "Total Deaths", value: commafy(stats?.deaths) },
      secondary: {
        label: "Total Deaths Per 1 Million",
    ...
    },
    {
      ...
      secondary: {
        label: "Total Tests Per 1 Million",
        value: commafy(parseInt(stats?.testsPerOneMillion)),
      },
    },
  ];
  ...
  const dashboardStatsToday = [
    {
      primary: {
        ...
        value: commafy(stats?.todayCases),
      },
    },
    {
      primary: {
        label: "Total Deaths Today",
        value: commafy(stats?.todayDeaths),
      },
    },
  ];
  ...
  const dashboardStatsRecovered = [
    ...
    {
      primary: {
        label: "Total Recovered per 1 Million",
        value: commafy(parseInt(stats?.recoveredPerOneMillion)),
      },
    },
    {
      primary: {
        label: "Total Recovered Today",
        value: commafy(stats?.todayRecovered),
      },
    },
  ];
      ...
      <div className="tracker">
        ...
        <div>
          <button onClick={() => setVisible(!visible)}>
            Toggle World and Per Population
          </button>
      ...
      <Container type="content" className="text-center home-start atBottom">
        <div className="row">
          <div className="column">
            ...
            <table className="table" id="dataTable2">
              <thead>
                <th>Stats </th>
            ...
            <table className="charts-css column show-heading">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  >
                    {" "}
                    {commafy(stats?.todayCases)}{" "}
                  </td>
                </tr>
              </tbody>
              <ul className="charts-css legend legend-circle">
                <li> Deaths Today </li>
          ...
          <div className="column">
            ...
            <p> {/* Newline */} </p>
            <table className="charts-css column multiple stacked show-heading">
              ...
              <tbody>
                <tr>
                  <td style={{ "--size": "1" }}>
                    <span className="data">
                      {" "}
                      {commafy(parseInt(stats?.deaths / 10))}{" "}
                    </span>
                  </td>
                  <td style={{ "--size": criticalCases / (totalDeaths / 10) }}>
                    <span className="data">{commafy(stats?.critical)} </span>
                  </td>
                </tr>
              </tbody>
            </table>
